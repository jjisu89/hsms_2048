...
const random_number = Math.floor(Math.random() * (17 - 0 + 1)) + 17;

var val2caption = function(val){

  const names = ["해빈","서안","민찬","시열","승기","의주","연아","유안","현정","민채","민준","성우","의서","명빈","의민","서연","은지",
  "해빈","서안","민찬","시열","승기","의주","연아","유안","현정","민채","민준","성우","의서","명빈","의민","서연","은지",
  "해빈","서안","민찬","시열","승기","의주","연아","유안","현정","민채","민준","성우","의서","명빈","의민","서연","은지"];
  const captions = names.slice(random_number, random_number+17);
